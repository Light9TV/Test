...
const tokenMeta = {
  ...
  "IRAR": "instant reverse aerial rush",
  "IDJ": "instant double jump",
  "Wavedash": "air dodge diagonally into the ground",
  "Waveland": "air dodge onto a platform or ground",
  "L-cancel": "reduced landing lag on aerials",
  "ASDI down": "automatic smash directional influence down",
  "WR": "while running",
  "WS": "while standing",
  "FC": "full crouch",
  "SS": "sidestep",
  ...
  "CH": "counter hit",
  "RA": "Rage Art",
  "DHC": "delayed hyper combo / tag super follow-up"
};
  ...
  return [
    {
      ...
      game: "SF6",
      character: "Terry",
      name: "Simple corner cashout",
      starter: "cr.MP",
      damage: "Add your real number",
      meter: "Drive + super optional",
      position: "Corner",
      difficulty: "Medium",
      tags: ["starter example", "corner"],
      favorite: true,
      routeTokens: ["cr.", "MP", "xx", "↓↘→", "HP", "›", "Drive Rush", "›", "cr.", "HP", "xx", "SA3"],
      notes: "Starter example. Edit or delete this after adding your own labbed route.",
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      game: "SSBU",
      character: "Terry",
      name: "Readable Smash example",
      starter: "D-tilt",
      damage: "Percent dependent",
      meter: "GO optional",
      position: "Midscreen",
      difficulty: "Easy",
      tags: ["starter example", "confirm"],
      favorite: false,
      routeTokens: ["D-tilt", "›", "D-tilt", "›", "Burn Knuckle", "or", "Power Dunk"],
      notes: "Use route cards for percent windows, DI notes, and kill confirm reminders.",
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      game: "Tekken 8",
      character: "Jin",
      name: "Wall carry shell",
      starter: "↘+2",
      damage: "Update after testing",
      meter: "Heat optional",
      position: "Midscreen → wall",
      difficulty: "Medium",
      tags: ["starter example", "wall carry"],
      favorite: false,
      routeTokens: ["↘+2", "›", "launch", "›", "microdash", "›", "Tornado", "›", "wall carry", "›", "wall splat"],
      notes: "Tekken limb buttons still use 1/2/3/4, but directions stay as arrows.",
      createdAt: now,
      updatedAt: now
    }
  ];
...
function renderRoutes() {
  ...
  let visible = routes.filter(route => {
    const haystack = [
      ...
      route.notes,
      ...(route.tags || []),
      readableRoute(route.routeTokens)
    ].join(" ").toLowerCase();

    return (game === "all" || route.game === game) &&
      (favMode === "all" || route.favorite) &&
...
function copyText(text) {
  navigator.clipboard?.writeText(text).then(
    () => showToast("Copied readable notation."),
    () => showToast("Copy failed. Select the route and copy manually.")
  );
}
  ...
  reader.onload = () => {
    try {
      ...
      if (!Array.isArray(imported)) {
        throw new Error("No routes array found");
      }
...
document.getElementById("cloudGoogleBtn")?.addEventListener("click", cloudGoogleLogin);
