    ...
    form.addEventListener("submit", event => {
      ...
      if (existingIndex >= 0) {
        routes[existingIndex] = { ...routes[existingIndex], ...data, updatedAt: now };
        showToast("Route updated.");
      } else {
        routes.unshift({ ...data, createdAt: now, updatedAt: now });
    ...
    document.getElementById("deleteEditingBtn").addEventListener("click", () => {
